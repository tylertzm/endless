  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        /* buttons now standardized via globals */
        .progress {
          height: 12px;
          background: transparent;
          border-radius: 6px;
      ...
      <div className="max-w-4xl mx-auto flex flex-col h-full gap-4">
        <div className="flex items-center gap-4" style={{ paddingTop: '8px' }}>
          ...
          <div className="text-sm text-white/60">Step {currentStep + 1} / {totalSteps}</div>
        </div>
        ...
        <div className="scrollable-form min-h-[20vh] overflow-y-auto">
          <div className="question-card">
                        ...
                        <div role="dialog" aria-modal="true" style={{ position: 'fixed', left: 0, top: 0, right: 0, bottom: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 120 }}>
                          <div style={{ background: 'rgba(10,10,10,0.98)', padding: '18px', borderRadius: '12px', width: 'min(520px, 94%)' }}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '8px', marginTop: '10px' }}>
                              ...
                              <button onClick={() => setPlatformPopup(null)} className="btn btn-ghost">Cancel</button>
                            </div>
                          </div>
                        </div>
                      )}
                    ...
                    <div className="flex gap-3">
                      <label className="flex-1 cursor-pointer">
                        <input
                          ...
                          className="hidden"
                        />
                        <div className="btn btn-outline w-full text-center">Choose Image</div>
                      </label>
                      {cardData.imageData && (
                        <button
              ...
              <div className="flex items-center gap-3 mt-4">
                <button onClick={goBack} disabled={currentStep === 0} className="btn btn-ghost">Back</button>
                {steps[currentStep] !== 'preview' ? (
